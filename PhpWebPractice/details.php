...
<div id="wrapper">
    <ul id="nav">
        ...
        <li><a href="journal.php" id="here">Journal</a></li>
        <li><a href="gallery.php">Gallery</a></li>
        <li><a href="contact.php">Contact</a></li>
    </ul>
    <div id="maincontent">
        <h1>Article details go here  </h1>
        ...
        <p>Sunt in culpa ut enim ad minim veniam, duis aute irure dolor. Ut aliquip ex ea commodo consequat. Excepteur sint occaecat cupidatat non proident. Ut labore et dolore magna aliqua.</p>
