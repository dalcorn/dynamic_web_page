    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div id="maincontent">
                ...
                <!-- display images randomly from images directory -->
                <?php include('includes/display_images.inc.php'); ?>
                <div id="pictureWrapper"><img src="<?php echo $path . $img ?>"  class="picBorder" /></div>
